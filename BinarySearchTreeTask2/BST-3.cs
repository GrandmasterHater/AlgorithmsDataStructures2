...
namespace AlgorithmsDataStructures2
{
    ...
    public class BST_3
    {
        ...
        [Test]
        public void TreeEquals_ForEqualsTrees_ReturnTrue()
        {
            BST<int> firstBst = CreateTree(out List<BSTNode<int>> firstNodes);
            BST<int> secondBst = CreateTree(out List<BSTNode<int>> secondNodes);
            
            Assert.That(firstBst.TreeEquals(secondBst), Is.True);
        }
        
        [Test]
        public void TreeEquals_ForNotEqualsTrees_ReturnFalse()
        {
            BST<int> firstBst = CreateTree(out List<BSTNode<int>> firstNodes);
            BST<int> secondBst = CreateTree(out List<BSTNode<int>> secondNodes);
            secondBst.DeleteNodeByKey(4);
            
            Assert.That(firstBst.TreeEquals(secondBst), Is.False);
        }

        #endregion

        #region GetPathsToLeafWithLength

        [Test]
        public void GetPathsToLeafWithLength_WhenTreeIsEmpty_ReturnEmptyList()
        {
            BST<int> bst = new BST<int>(null);
            
            Assert.That(bst.GetPathsToLeafWithLength(0), Is.Empty);
        }
        
        [Test]
        public void GetPathsToLeafWithLength_WhenTreeWithOnlyRoot_ReturnEmptyList()
        {
            BST<int> bst = new BST<int>(new BSTNode<int>(1, 1, null));
            
            Assert.That(bst.GetPathsToLeafWithLength(0), Is.Empty);
        }
        
        [Test]
        public void GetPathsToLeafWithLength_WhenTreeIsFullBinaryTree_ReturnAllPaths()
        {
            BST<int> bst = CreateTree(out List<BSTNode<int>> nodes);
            int length = 3;
            int expectedCount = 8;
            
            Assert.That(bst.GetPathsToLeafWithLength(length).Count, Is.EqualTo(expectedCount));
        }
        
        [Test]
        public void GetPathsToLeafWithLength_WhenTreeIsCompleteBinaryTree_ReturnAllPaths()
        {
            BST<int> bst = CreateTree(out List<BSTNode<int>> nodes);
        ...
        #region GetPathsToLeafWithMaxSum

        [Test]
        public static void GetPathsToLeafWithMaxSum_WhenTreeIsEmpty_ReturnEmptyList()
        {
            BST<int> bst = new BST<int>(null);
            
            Assert.That(bst.GetPathsToLeafWithMaxSum(), Is.Empty);
        }
        
        [Test]
        public static void GetPathsToLeafWithMaxSum_WhenTreeWithOnlyRoot_ReturnEmptyList()
        {
            BST<int> bst = new BST<int>(new BSTNode<int>(1, 1, null));
        ...
        [Test]
        public static void GetPathsToLeafWithMaxSum_WhenTreeIsFullBinaryTree_ReturnAllPaths()
        {
            BST<int> bst = CreateTree(out List<BSTNode<int>> nodes);
            int expectedCount = 1;
            int expectedSum = 8 + 12 + 14 + 15;

            var result = bst.GetPathsToLeafWithMaxSum();
            
            Assert.That(result.Count, Is.EqualTo(expectedCount));
            Assert.That(result.First().Sum(node => node.NodeValue), Is.EqualTo(expectedSum));
        }

        #endregion

        #region IsTreeSymmetrically

        [Test]
        public void IsTreeSymmetrically_WhenTreeIsSymmetric_ReturnTrue()
        {
            BST<int> bst = CreateTree(out List<BSTNode<int>> nodes);
            
            Assert.That(bst.IsTreeSymmetrically(), Is.True);
        }
        
        [Test]
        public void IsTreeSymmetrically_WhenTreeIsAsymmetric_ReturnFalse()
        {
            BST<int> bst = CreateTree(out List<BSTNode<int>> nodes);
            bst.DeleteNodeByKey(1);
            
            Assert.That(bst.IsTreeSymmetrically(), Is.False);
        }
        
        [Test]
        public void IsTreeSymmetrically_WhenTreeHasOnlyRoot_ReturnTrue()
        {
            BST<int> bst = new BST<int>(new BSTNode<int>(1, 1, null));
        ...
        [Test]
        public void IsTreeSymmetrically_WhenTreeIsEmpty_ReturnTrue()
        {
            BST<int> bst = new BST<int>(null);
